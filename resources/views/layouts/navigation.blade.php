            ...
            <div class="flex">
                ...
                <div class="flex flex-row items-center">
                    ...
                    <a href="{{ route('dashboard') }}">
                        <img src="/images/logo.png" class="block h-9 fill-current  dark:text-gray-200 text-gray-500"
                            alt="">

                    </a>
                    <p class="text-lg font-semibold pl-2">DevDes.id</p>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('project_admin')" :active="request()->routeIs('project_admin')">
                        {{ __('Project') }}
                    </x-nav-link>
                    <x-nav-link :href="route('category_project_admin')" :active="request()->routeIs('category_project_admin')">
                        {{ __('Category Project') }}
                    </x-nav-link>
