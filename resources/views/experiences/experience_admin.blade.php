<x-app_dashbord-layout>
    ...
    <div class="container py-12 p-12 max-sm:p-8 max-sm:min-w-full">
        ...
        <section class="table-project bg-white">
                    ...
                    <tbody>
                        ...
                        @foreach ($exp as $ex)
                            <tr
                                ...
                                <td class="px-6 py-4 w-96 text-justify">
                                    {!! $ex->desc_exp !!}
                                </td>
                                <td class="px-6 py-4">
                                    ...
                                    <div id="dropdownDivider-{{$ex->id}}"
                                        ...
                                        <ul class="py-0 text-sm  dark:text-gray-200"
                                            ...
                                            <li>
                                                <a class=" hover:bg-yellow-200 mt-0"
                                                    href="{{ route('experience_admin_edit', $ex->id) }}">
                                                    <div
                                        ...
                                        <div class="py-0">
                                            <a class="hover:bg-green-200"
                                                href="{{ route('experience_admin_delete', $ex->id) }}">
                                                <div
